...
export const HorizonHeroSection = () => {
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      <div 
        ref={menuRef} 
        className="fixed left-8 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-6"
        style={{ visibility: 'hidden' }}
      >
        <div className="flex flex-col gap-3">
          <span className="block w-6 h-0.5 bg-white/60" />
          <span className="block w-4 h-0.5 bg-white/40" />
          <span className="block w-6 h-0.5 bg-white/60" />
        </div>
        <span className="text-white/60 text-xs tracking-[0.3em] rotate-180" style={{ writingMode: 'vertical-rl' }}>
          SPACE
        </span>
      </div>
      ...
      <div className="relative z-10 h-screen flex flex-col items-center justify-center">
        <div 
          ref={titleRef} 
          className="text-[12vw] font-bold text-white tracking-tight leading-none overflow-hidden"
          style={{ visibility: 'hidden' }}
        >
          {splitTitle('HORIZON')}
        </div>
        ...
        <div 
          ref={subtitleRef} 
          className="mt-8 text-center text-white/70 text-lg md:text-xl tracking-wide"
          style={{ visibility: 'hidden' }}
        >
          <div className="subtitle-line overflow-hidden">
            <span className="block">Where vision meets reality,</span>
          </div>
          <div className="subtitle-line overflow-hidden">
            <span className="block">we shape the future of tomorrow</span>
          </div>
        </div>
      </div>
      ...
      <div 
        ...
        className="fixed right-8 bottom-8 z-50 flex flex-col items-center gap-4"
        style={{ visibility: 'hidden' }}
      >
      ...
      <div className="relative z-10">
        {[...Array(2)].map((_, i) => {
          ...
          return (
            <div key={i} className="h-screen flex flex-col items-center justify-center">
              <h2 className="text-[12vw] font-bold text-white tracking-tight leading-none">
                {titles[i + 1] || 'DEFAULT'}
              </h2>
              <div className="mt-8 text-center text-white/70 text-lg md:text-xl tracking-wide">
                <p className="mb-2">{subtitles[i + 1].line1}</p>
